...
namespace PaymentContext.Domain.Handlers
{
    ...
    {
        private readonly IStudenRepository _repository;
        private readonly IEmailService _emailService;
        public SubscriptionHandler(IStudenRepository repository, IEmailService emailService)
        {
        ...
        public ICommandResult Handle(CreateBoletoSubscriptionCommand command)
        {
            ...
            _emailService.Send(student.Name.ToString(), student.Email.Address, "Bem vindo ao CURSOSSOSOSSO!", "Sua assinatura foi criada.");
